...
int main()
{
    ...
    int w = 4;
    int h = 5;
    auto img = image_opencl<type>::new_pointer(w,h);
    ...
    // Comput gradient
    typename image_opencl<type>::vector grad(2);
    grad = gradient(img);
    img->print_data("i");
    ...
    // Create image
    int l = 3;
    auto img3 = image_opencl<type>::new_pointer(w,h,l);
    ...
    // Comput gradient
    typename image_opencl<type>::vector grad3(3);
    grad3 = gradient(img3);
    img3->print_data("i");
