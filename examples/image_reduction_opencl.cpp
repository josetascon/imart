...
* @Last Modified time: 2020-07-20 15:17:05
*/
...
int main()
{
    ...
    image_opencl<type> image1(811,604);
    image1.ones();
    ...
    image_opencl<type> image2(201,125,153);
    image2.ones();
    ...
    image_opencl<type> image3(5,1);
    *image3.get_data() = {1.0, 2.0, 3.0, 1.0, 4.0};
    
    type x;
    image_opencl<type> result = image3*image3;
    x = result.sum();
