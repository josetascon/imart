...
* @Last Modified time: 2021-05-17 15:40:46
*/
...
int main(int argc, char *argv[])
{
    ...
    std::string file_output = "./moving_horn_schunck_";
    bool verbose;
    bool plot;
    ...
    auto track1 = horn_schunck<type,vector_cpu<type>>::new_pointer(img_fixed, img_moving, trfm);
