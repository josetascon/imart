...
* @Last Modified time: 2020-08-28 11:58:00
*/
...
int main()
{
    ...
    auto image2 = image_cuda<type>::new_pointer(5,3);

    // Create identity transform
    auto dfield1 = dfield_cuda<type>::new_pointer(image2);
    // Create other transform
    auto dfield2 = dfield_cuda<type>::new_pointer(image2);
    ...
    // ============================================
    // Grid
    auto x0 = grid_cuda<type>::new_pointer(image2);
    ...
    // Image to create grid
    auto image3 = image_cuda<type>::new_pointer(4,2,3);

    // Create identity transform
    auto dfield11 = dfield_cuda<type>::new_pointer(image3);
    // Create other transform
    auto dfield12 = dfield_cuda<type>::new_pointer(image3);
    ...
    // ============================================
    auto x10 = grid_cuda<type>::new_pointer(image3);
