...
* @Last Modified time: 2020-08-08 06:57:17
*/
...
int main()
{
    ...
    auto dfield1 = dfield_cpu<type>::new_pointer(image2);
    ...
    // ============================================
    // Grid
    auto x0 = grid_cpu<type>::new_pointer(image2);
    ...
    // Image to create grid
    auto image3 = image_cpu<type>::new_pointer(4,2,3);

    // Create identity transform
    auto dfield11 = dfield_cpu<type>::new_pointer(image3);
    // Create other transform
    auto dfield12 = dfield_cpu<type>::new_pointer(image3);
    ...
    // ============================================
    auto x10 = grid_cpu<type>::new_pointer(image3);
