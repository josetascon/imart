...
* @Last Modified time: 2020-08-31 19:07:49
*/
...
template <typename T>
class test_dfield_cpu : public ::testing::Test{};
...
// ============================================
TYPED_TEST_CASE(test_dfield_cpu, test_types);

TYPED_TEST(test_dfield_cpu, constructor)
{
    dfield_cpu<TypeParam> field1;
    ...
    dfield_cpu<TypeParam> field4(std::vector<int>{22,14});
    ...
    dfield_cpu<TypeParam> field5(std::vector<int>{8,54,31});
    ...
    auto img1 = image_cpu<TypeParam>::new_pointer(18,13);
    dfield_cpu<TypeParam> field6(img1);
    ...
    auto img2 = image_cpu<TypeParam>::new_pointer(19,11);
    auto grid2 = image_cpu<TypeParam>::new_pointer(*img2);
    dfield_cpu<TypeParam> field7(grid2);
    ...
    auto img3 = image_cpu<TypeParam>::new_pointer(14,15,12);
    dfield_cpu<TypeParam> field8(img3);
    ...
    auto img4 = image_cpu<TypeParam>::new_pointer(31,21,11);
    auto grid4 = grid_cpu<TypeParam>::new_pointer(*img4);
    dfield_cpu<TypeParam> field9(grid4);
    ...
    dfield_cpu<TypeParam> field10(field9);
...
//          Testing Pointers
// ============================================
TYPED_TEST(test_dfield_cpu, pointers)
{
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer();
    ASSERT_TRUE("dfield" == field1->get_name());
    ASSERT_EQ( 2, field1->get_dimension() );
    ASSERT_EQ( 0, field1->get_size()[0] );
    ASSERT_EQ( 0, field1->get_size()[1] );
    ...
    fieldcpu_pointer field2 = dfield_cpu<TypeParam>::new_pointer(2);
    ASSERT_TRUE("dfield" == field2->get_name());
    ASSERT_EQ( 2, field2->get_dimension() );
    ASSERT_EQ( 0, field2->get_size()[0] );
    ASSERT_EQ( 0, field2->get_size()[1] );
    ...
    fieldcpu_pointer field3 = dfield_cpu<TypeParam>::new_pointer(3);
    ASSERT_TRUE("dfield" == field3->get_name());
    ASSERT_EQ( 3, field3->get_dimension() );
    ASSERT_EQ( 0, field3->get_size()[0] );
    ASSERT_EQ( 0, field3->get_size()[1] );
    ...
    fieldcpu_pointer field4 = dfield_cpu<TypeParam>::new_pointer(std::vector<int>{7,8});
    ASSERT_TRUE("dfield" == field4->get_name());
    ASSERT_EQ( 2, field4->get_dimension() );
    ...
    fieldcpu_pointer field5 = dfield_cpu<TypeParam>::new_pointer(std::vector<int>{9,5,3});
    ASSERT_TRUE("dfield" == field5->get_name());
    ASSERT_EQ( 3, field5->get_dimension() );
...
// ============================================
TYPED_TEST(test_dfield_cpu, inheritance)
{
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field2 = dfield_cpu<TypeParam>::new_pointer(2);
    ASSERT_EQ( 2, field2->get_dimension() );
...
// ============================================
TYPED_TEST(test_dfield_cpu, clones)
{
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(std::vector<int>{8,5});
    ...
    fieldcpu_pointer field2 = field1->clone();
    fieldcpu_pointer field3 = field1->copy();
    fieldcpu_pointer field4 = field1->mimic();
    ...
    using transformcpu_pointer = typename transform_cpu<TypeParam>::pointer;
    transformcpu_pointer field5 = field1->clone();
    transformcpu_pointer field6 = field1->copy();
    transformcpu_pointer field7 = field1->mimic();
    ...
    // second mimic
    transformcpu_pointer field8 = field6->clone();
    transformcpu_pointer field9 = field6->copy();
    transformcpu_pointer field10 = field6->mimic();
...
// ============================================
TYPED_TEST(test_dfield_cpu, initialization)
{
    int size = 50;
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(size);
    fieldcpu_pointer field2 = field1->mimic();
    fieldcpu_pointer field3 = field1->mimic();
...
// ============================================
TYPED_TEST(test_dfield_cpu, vector_operations)
{
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(30,2.1);
    fieldcpu_pointer field2 = dfield_cpu<TypeParam>::new_pointer(30,1.1);
    fieldcpu_pointer field3;
    fieldcpu_pointer field4 = dfield_cpu<TypeParam>::new_pointer(30,4.2);
    fieldcpu_pointer field5;
    fieldcpu_pointer field6 = dfield_cpu<TypeParam>::new_pointer(30,14.2123);
    fieldcpu_pointer vec7;
    fieldcpu_pointer vec8 = dfield_cpu<TypeParam>::new_pointer(30,-2*14.2123);
    fieldcpu_pointer vec9;
    fieldcpu_pointer field10 = dfield_cpu<TypeParam>::new_pointer(30,4.0);
    fieldcpu_pointer field11;
...
// ============================================
TYPED_TEST(test_dfield_cpu, scalar_operations)
{
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(14,1.5);
    fieldcpu_pointer field2 = dfield_cpu<TypeParam>::new_pointer(16,-4.632);
    fieldcpu_pointer field3 = dfield_cpu<TypeParam>::new_pointer(18,-12.0);
    fieldcpu_pointer field4 = dfield_cpu<TypeParam>::new_pointer(20,8.4);
    fieldcpu_pointer field5 = dfield_cpu<TypeParam>::new_pointer(22,2.0);
    fieldcpu_pointer field6;
    fieldcpu_pointer vec7;
    fieldcpu_pointer vec8;
    fieldcpu_pointer vec9;
    fieldcpu_pointer field10;
...
// ============================================
TYPED_TEST(test_dfield_cpu, reduction_operations)
{
    int size = 32;
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(size,0.0);
    fieldcpu_pointer field2 = dfield_cpu<TypeParam>::new_pointer(size,0.0);
...
// ============================================
TYPED_TEST(test_dfield_cpu, auxialiary_functions)
{
    int size = 32;
    using fieldcpu_pointer = typename dfield_cpu<TypeParam>::pointer;

    // cast function
    fieldcpu_pointer field1 = dfield_cpu<TypeParam>::new_pointer(size,-1.1);

    dfield_cpu<int>::pointer field2 = field1->template cast<int>();
    dfield_cpu<float>::pointer field3 = field1->template cast<float>();
    dfield_cpu<double>::pointer field4 = field1->template cast<double>();
    dfield_cpu<unsigned int>::pointer field5 = field1->template cast<unsigned int>();
    ...
    // normalize function
    fieldcpu_pointer field11 = dfield_cpu<TypeParam>::new_pointer(size,0.0);
    fieldcpu_pointer field12 = dfield_cpu<TypeParam>::new_pointer(size,0.0);
    fieldcpu_pointer field13;
    fieldcpu_pointer field14;
