...
* @Last Modified time: 2020-08-30 22:10:18
*/
...
static void bm_inearest_cuda_2d(benchmark::State& state)
{
    // Perform setup here
    using type = float;     //4 Bytes
    int N = state.range(0); 
    ...
    auto interp0 = inearest_cuda<type>::new_pointer(image0);
    x1 = taffine->apply(x0);
...
static void bm_inearest_cuda_3d(benchmark::State& state)
{
    // Perform setup here
    using type = float;     //4 Bytes
    int N = state.range(0); 
...
BENCHMARK(bm_inearest_gpu_2d)->RangeMultiplier(10)->Range(10, 10000);
BENCHMARK(bm_inearest_cuda_2d)->RangeMultiplier(10)->Range(10, 10000);
BENCHMARK(bm_inearest_cpu_3d)->RangeMultiplier(10)->Range(10, 400);
BENCHMARK(bm_inearest_gpu_3d)->RangeMultiplier(10)->Range(10, 400);
BENCHMARK(bm_inearest_cuda_3d)->RangeMultiplier(10)->Range(10, 400);
