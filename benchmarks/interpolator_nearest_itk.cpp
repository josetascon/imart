...
* @Last Modified time: 2021-02-18 13:23:03
*/
...
BENCHMARK(bm_inearest_opencl_2d)->RangeMultiplier(10)->Range(10, 5000);
...
BENCHMARK(bm_inearest_opencl_3d)->RangeMultiplier(10)->Range(10, 300);
